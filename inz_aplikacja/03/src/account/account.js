  ...
  return ( 
    <View style={styles.main_container}>
      <View style={styles.info_container}>
            ...
            <Text style={{fontSize: 24}}>Ustawienia konta</Text>
      </View>
      <View style={styles.options_container}>
        <TouchableOpacity style={styles.option_container} onPress={() => navigation.navigate('DifficultyLevel')}>
        <View style={styles.game}>
          <Ionicons name={'speedometer-outline'} size={40} color="#1E918E" />
            <Text style={{ marginLeft: 10, fontSize: 20}}>Poziom trudności</Text>
        </View>
        </TouchableOpacity>
        ...
        <TouchableOpacity style={styles.option_container} onPress={handleLogout}>
        <View style={styles.game}>
