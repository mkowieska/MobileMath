...
const Add3MediumPage = ({ navigation }) => {
  return ( 
    <View style={styles.main_container}>
      <View style={styles.categories_container}>
        <Text style={{fontSize: 24}}>Dodawanie</Text> 
        <Text style={{fontSize: 20}}>Poziom: Bardzo średni</Text>
          <TouchableOpacity style={styles.calculations_container} onPress={() => navigation.navigate('Add3Explanation')}>
            <View style={styles.calculations}>
              <Ionicons name={'file-tray-full-outline'} size={40} color="#1E918E" />
              <Text style={{ marginLeft: 10, fontSize: 20}}>Wyjaśnienia</Text>
            </View>
          </TouchableOpacity>
          <TouchableOpacity style={styles.calculations_container} onPress={() => navigation.navigate('Add3Exercise')}>
            <View style={styles.calculations}>
              <Ionicons name={'document-text-outline'} size={40} color="#1E918E" />
              <Text style={{ marginLeft: 10, fontSize: 20}}>Zadania</Text>
            </View>
          </TouchableOpacity>
          <TouchableOpacity style={styles.calculations_container} onPress={() => navigation.navigate('Add3Test')}>
            <View style={styles.calculations}>
