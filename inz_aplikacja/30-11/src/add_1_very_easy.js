...
const Add1VeryEasyPage = ({ navigation }) => {
  return ( 
    <View style={styles.main_container}>
      <View style={styles.categories_container}>
        <Text style={{fontSize: 24}}>Dodawanie</Text>
        <Text style={{fontSize: 20}}>Poziom: Bardzo łatwy </Text>
          <TouchableOpacity style={styles.calculations_container} onPress={() => navigation.navigate('Add1Exercise')}>
            <View style={styles.calculations}>
              <Ionicons name={'file-tray-full-outline'} size={40} color="#1E918E" />
              <Text style={{ marginLeft: 10, fontSize: 20}}>Wyjaśnienia</Text>
            </View>
          </TouchableOpacity>
          <TouchableOpacity style={styles.calculations_container} onPress={() => navigation.navigate('Add1Explanation')}>
            <View style={styles.calculations}>
              <Ionicons name={'document-text-outline'} size={40} color="#1E918E" />
              <Text style={{ marginLeft: 10, fontSize: 20}}>Zadania</Text>
            </View>
          </TouchableOpacity>
          <TouchableOpacity style={styles.calculations_container} onPress={() => navigation.navigate('Add1Test')}>
            <View style={styles.calculations}>
...
export default Add1VeryEasyPage;